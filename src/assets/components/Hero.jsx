            ...
            <section className="hero-container">
                ...
                <h1>Junior Front-End Developer and UI/UX Designer</h1>
                    <div className="hero-story scroll">
                        ...
                        <p className="about-text ">Software developer passionate about creating efficient and user-friendly web solutions. Completed a qualification in Information Technology and Computer Science at Nkangala TVET College.
                        </p>
                    </div>
